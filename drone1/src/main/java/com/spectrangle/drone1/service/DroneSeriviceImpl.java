...
import com.spectrangle.drone1.repository.DroneDeliveryRepository;
import com.spectrangle.drone1.repository.DroneRepository;
import com.spectrangle.drone1.repository.MedicationRepository;
import data.response.RegisterDroneResponse;
...
public class DroneSeriviceImpl implements DroneService {
	...
	@Autowired
	private com.spectrangle.drone1.repository.loadDroneRepository loadDroneRepository;
	@Autowired
	...
	@Override
	public DroneBatteryDetailsResponse getBateryLevel(DroneGetBatteryRequest drequest) throws Exception {
		return null;
	}
